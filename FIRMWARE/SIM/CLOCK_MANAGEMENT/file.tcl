...
set CLOCK_MANAGEMENT_VERILOG_STR [collect_verilog_files "$CLOCK_MANAGEMENT_DIRECTORIES"]
set CLOCK_MANAGEMENT_VERILOG_TESTBENCHS_STR [collect_verilog_files "$TESTBENCH_DIRECTORIES"]
