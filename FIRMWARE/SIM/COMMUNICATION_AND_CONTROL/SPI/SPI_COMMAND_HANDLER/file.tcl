...
set SPI_COMMAND_HANDLER_VERILOG_STR [collect_verilog_files "$SPI_COMMAND_HANDLER_DIRECTORIES"]
set SPI_COMMAND_HANDLER_VERILOG_TESTBENCHS_STR [collect_verilog_files "$TESTBENCH_DIRECTORIES"]
