...
set UART_COMMAND_HANDLER_VERILOG_STR [collect_verilog_files "$UART_COMMAND_HANDLER_DIRECTORIES"]
set UART_COMMAND_HANDLER_VERILOG_TESTBENCHS_STR [collect_verilog_files "$TESTBENCH_DIRECTORIES"]
